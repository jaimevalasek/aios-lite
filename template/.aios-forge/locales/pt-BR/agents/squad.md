...
Um squad é um **time de agentes reais e invocáveis** criados em `.aios-forge/squads/{squad-slug}/agents/`.
...
- `@squad design <slug>` → leia e execute `.aios-forge/tasks/squad-design.md`
- `@squad create <slug>` → leia e execute `.aios-forge/tasks/squad-create.md`
- `@squad validate <slug>` → leia e execute `.aios-forge/tasks/squad-validate.md`
- `@squad analyze <slug>` → leia e execute `.aios-forge/tasks/squad-analyze.md` (Fase 3)
- `@squad extend <slug>` → leia e execute `.aios-forge/tasks/squad-extend.md` (Fase 3)
- `@squad repair <slug>` → leia e execute `.aios-forge/tasks/squad-repair.md` (Fase 4)
- `@squad export <slug>` → leia e execute `.aios-forge/tasks/squad-export.md` (Fase 3)
...
- atualize `.aios-forge/squads/{slug}/squad.md`
- registre se o genoma vale para o squad inteiro ou apenas para agentes específicos
- reescreva os arquivos dos agentes afetados em `.aios-forge/squads/{squad-slug}/agents/` para incluir o novo genoma ativo
...
- um pacote em `.aios-forge/squads/{squad-slug}/`
- um manifesto curto em `.aios-forge/squads/{squad-slug}/agents/agents.md`
- um manifesto estruturado em `.aios-forge/squads/{squad-slug}/squad.manifest.json`
- skills em `.aios-forge/squads/{squad-slug}/skills/`
- templates em `.aios-forge/squads/{squad-slug}/templates/`
- um `design-doc` local em `.aios-forge/squads/{squad-slug}/docs/design-doc.md`
- um `readiness` local em `.aios-forge/squads/{squad-slug}/docs/readiness.md`
...
- verifique tambem se a squad ja tem skills instaladas em `.aios-forge/squads/{squad-slug}/skills/` antes de criar skills novas ou duplicadas
...
Crie `.aios-forge/squads/{squad-slug}/agents/agents.md`:
...
Crie também `.aios-forge/squads/{squad-slug}/squad.manifest.json` com este schema mínimo:
...
```json
{
  ...
  "package": {
    "rootDir": ".aios-forge/squads/{squad-slug}",
    "agentsDir": ".aios-forge/squads/{squad-slug}/agents",
    "skillsDir": ".aios-forge/squads/{squad-slug}/skills",
    "templatesDir": ".aios-forge/squads/{squad-slug}/templates",
    "docsDir": ".aios-forge/squads/{squad-slug}/docs"
  },
  "rules": {
  ...
  "executors": [
    {
      ...
      "file": ".aios-forge/squads/{squad-slug}/agents/orquestrador.md",
      "skills": [],
      "genomes": []
    }
  ],
...
Se precisar definir campos especificos do dominio, faça isso dentro do blueprint da squad, nunca como regra fixa global do AIOS Forge.

### Passo 2 — Gere cada agente especialista

Para cada papel, crie `.aios-forge/squads/{squad-slug}/agents/{role-slug}.md`:
...
Crie `.aios-forge/squads/{squad-slug}/agents/orquestrador.md`:
...
- `.aios-forge/context/` aceita somente arquivos `.md` — não escreva arquivos não-markdown lá
...
```markdown
## Squad: {squad-name}
- /{role1} -> .aios-forge/squads/{squad-slug}/agents/{role1}.md
- /{role2} -> .aios-forge/squads/{squad-slug}/agents/{role2}.md
- /orquestrador -> .aios-forge/squads/{squad-slug}/agents/orquestrador.md
```
...
Salve um resumo em `.aios-forge/squads/{slug}/squad.md`:
```
Squad: {squad-name}
Mode: Squad
Goal: {goal}
Agents: .aios-forge/squads/{squad-slug}/agents/
Manifest: .aios-forge/squads/{squad-slug}/squad.manifest.json
...
Agentes criados em `.aios-forge/squads/{squad-slug}/agents/`:
- @{role1} — [descrição em uma linha]
- @{role2} — [descrição em uma linha]
- @{role3} — [descrição em uma linha]
...
Manifestos da squad criados em `.aios-forge/squads/{squad-slug}/agents/agents.md` e `.aios-forge/squads/{squad-slug}/squad.manifest.json`.
```
...
- Agentes vão em `.aios-forge/squads/{squad-slug}/agents/`, HTML em `output/{squad-slug}/` — NÃO dentro de `.aios-forge/`.
- Logs brutos vão apenas em `aios-logs/{squad-slug}/` na raiz do projeto — nunca dentro de `.aios-forge/`.
...
- Arquivos dos agentes: `.aios-forge/squads/{squad-slug}/agents/` (editáveis pelo usuário, invocáveis via `@`)
- Manifesto textual da squad: `.aios-forge/squads/{squad-slug}/agents/agents.md`
- Manifesto JSON da squad: `.aios-forge/squads/{squad-slug}/squad.manifest.json`
- Metadados do squad: `.aios-forge/squads/{slug}/squad.md`
- HTMLs de sessão: `output/{squad-slug}/{session-id}.html`
- Latest HTML: `output/{squad-slug}/latest.html`
- Drafts `.md`: `output/{squad-slug}/`
- Genomas vinculados: `.aios-forge/squads/{slug}/squad.md`
- Logs: `aios-logs/{squad-slug}/`
- Midia: `media/{squad-slug}/`
