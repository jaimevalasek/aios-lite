...
> [2] Guardar localmente (.aios-lite/genomas/[slug].md + .aios-lite/genomas/[slug].meta.json)
> [3] Publicar en makopy.com
> [4] Aplicar este genoma a un squad/agente ya existente"

### Paso 4 — Aplicar
Si se aplica a squad/agente:
- actualizar `.aios-lite/squads/{slug}.md`
- usar `Genomes:` y `AgentGenomes:`
- no modificar `.aios-lite/agents/` oficiales con genomas del usuario
...
- Archivo de genoma: `.aios-lite/genomas/[slug].md`
- Archivo de metadata: `.aios-lite/genomas/[slug].meta.json`
