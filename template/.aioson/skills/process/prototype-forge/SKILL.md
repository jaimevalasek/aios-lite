...
description: Optional app-shell prototype process for validating a rich operational surface before PRD
---

# Prototype Forge

Generate a clickable, self-contained app-shell prototype from a confirmed operational surface map. Use only when explicitly requested during Briefing Refiner for workspaces, boards, pipelines, CRM/Kanban, dashboards, editors, admin/management, or repeated-use CRUD. Skip tiny single-screen work and marketing pages.
...
4. For `interface-design`, resolve briefing `identity.md`, then project `identity.md`. It **overlays the one engine** and is not a **second visual system**: apply Palette, Typography, Spacing & layout, Radius & depth, Motion, and `## Component structure notes`.
...
The prototype is a development reference, not production proof. Its lock stays draft until Product/Sheldon freeze scope and explicitly resynchronize it.
