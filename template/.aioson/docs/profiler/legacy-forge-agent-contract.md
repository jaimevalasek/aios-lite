---
description: Historical full Profiler Forge contract preserved for compatibility archaeology
agents: [profiler-forge]
task_types: [legacy-contract-reference]
load_tier: archive
---

# Legacy @profiler-forge Agent Contract

> **NON-EXECUTABLE HISTORY:** Do not load this file during normal forging. The compact kernel and routed profiler modules supersede it. Consult it only to diagnose a legacy behavior or migration regression.
