---
description: Historical monolithic Copywriter agent contract retained for compatibility archaeology
agents: [copywriter]
task_types: [legacy-copy-contract-audit]
triggers: [removed copywriter rule, legacy copywriter behavior, compatibility investigation]
---

# Legacy Copywriter Agent Contract

> Historical snapshot only. Non-executable and excluded from ordinary copy work. The active kernel is `.aioson/agents/copywriter.md`.
