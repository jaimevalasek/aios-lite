...
> L'utilisateur a demande une interface command center premium. @ux-ui doit lire `.aioson/skills/static/premium-command-center-ui.md` avant tout travail de design.
```
