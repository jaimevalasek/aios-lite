  ...
  it('qa contract passes Gate D when QA passes and AC has test evidence', async () => {
    ...
    await fs.writeFile(
      ...
      [
        ...
        '| CAP | Promised outcome | Actor / trigger | Scope decision | Rationale |',
         ...
         '|---|---|---|---|',
         '| CAP-feat-verify | Existing Node test boundary inspected at tests/feat.test.js | extend | Add the approved observable verification through the existing test boundary |',
         '## Acceptance Criteria',
    ...
    await fs.writeFile(
      ...
      [
         ...
         '|---|---|---|---|---|',
         '| compatibility | Existing Node test boundary | Preserve the current test runner contract | node --test tests/feat.test.js | Revert the added test; no persistent data |',
         '## Implementation Delta',
         '| CAP | Action | Existing evidence | Exact paths | Required change |',
         '|---|---|---|---|---|',
         '| CAP-feat-verify | create | Existing Node test boundary and neighboring tests were inspected | tests/feat.test.js | Add AC-linked executable verification |',
