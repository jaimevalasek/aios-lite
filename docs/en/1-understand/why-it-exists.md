...
**In practice:** the AI won't ask you for a 30-page PRD for a 50-line script. Every tracked feature keeps the same Product → Sheldon → Planner → DEV → QA chain, while the depth, budget, and evidence stay proportional.
