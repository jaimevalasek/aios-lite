...
module.exports = {
  cli: {
    ...
    help_live_start:
      'aioson live:start [path] --tool=codex|claude|gemini|opencode --agent=<nome> [--tool-bin=<binario>] [--tool-args=<args>] [--title=<texto>] [--goal=<texto>] [--plan=<arquivo>] [--session=<chave>] [--message=<texto>] [--no-launch] [--json] [--locale=pt-BR]',
    help_live_status:
