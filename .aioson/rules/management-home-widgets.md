...
- @refiner / @benchmark: a management-domain prototype or benchmark build without a value-bearing home is a blocking finding; widgets must be fed by the seeded mock state.
