---
description: Historical full Orache agent contract preserved for compatibility archaeology
agents: [orache]
task_types: [legacy-contract-reference]
load_tier: archive
---

# Legacy Agent @orache Contract

> **NON-EXECUTABLE HISTORY:** Do not load this file during normal domain investigation. The active kernel and routed modules supersede it. Consult it only to diagnose a legacy behavior or migration regression.
