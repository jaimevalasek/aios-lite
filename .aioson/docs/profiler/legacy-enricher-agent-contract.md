---
description: Historical full Profiler Enricher contract preserved for compatibility archaeology
agents: [profiler-enricher]
task_types: [legacy-contract-reference]
load_tier: archive
---

# Legacy @profiler-enricher Agent Contract

> **NON-EXECUTABLE HISTORY:** Do not load this file during normal enrichment. The compact kernel and routed profiler modules supersede it. Consult it only to diagnose a legacy behavior or migration regression.
