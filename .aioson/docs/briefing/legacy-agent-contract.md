---
description: Historical full Briefing agent contract preserved for compatibility archaeology
agents: [briefing]
task_types: [legacy-contract-reference]
load_tier: archive
---

# Legacy Agent @briefing Contract

> **NON-EXECUTABLE HISTORY:** Do not load this file during normal Briefing work. The active kernel and routed modules supersede it. Consult it only to investigate a legacy behavior or migration regression.
